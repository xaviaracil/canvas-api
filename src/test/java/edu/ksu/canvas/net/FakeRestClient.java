...
public class FakeRestClient implements RestClient {
    ...
    @Override
    public Response sendApiPost(AuthorizationToken token, String url, Map<String, List<String>> postParameters, int connectTimeout, int readTimeout) throws InvalidAuthTokenException, IOException {
    ...
    @Override
    public Response sendApiPostFile(AuthorizationToken token, String url, Map<String, List<String>> postParameters, String fileParameter, String filePath, InputStream is, int connectTimeout, int readTimeout) throws InvalidAuthTokenException, IOException {
        LOG.debug("Sending fake POST to " + url);
        checkForTimeout(connectTimeout, readTimeout);
        return response(url);
    }
