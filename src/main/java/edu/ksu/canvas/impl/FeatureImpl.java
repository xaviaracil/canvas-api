...
public class FeatureImpl extends BaseImpl<Feature, FeatureReader, FeatureWriter> implements FeatureReader {
     ...
     */
    public FeatureImpl(String canvasBaseUrl, Integer apiVersion, AuthorizationToken authorizationToken, RestClient restClient, int connectTimeout, int readTimeout, Integer paginationPageSize, Boolean serializeNulls) {
